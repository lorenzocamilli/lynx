...
func init() {
	...
	gob.RegisterName("github.com/lorenzocamilli/lynx/pkg/search.PrefixExpression", PrefixExpression{})
	gob.RegisterName("github.com/lorenzocamilli/lynx/pkg/search.InfixExpression", InfixExpression{})
	gob.RegisterName("github.com/lorenzocamilli/lynx/pkg/search.StringLiteral", StringLiteral{})
	gob.RegisterName("github.com/lorenzocamilli/lynx/pkg/search.RegexpLiteral", RegexpLiteral{})
}
